...
## Features
* **Username Validation:** Ensures that the user onl inserts a username that has an underscore (_) and is not longer than five characters.
* **Password Complexity:** Validates that the user pssword is atleast eight characters long, and contains a capital letter, a number and a special character.
